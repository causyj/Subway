...
public class Button{
    ...
    public static void main(String[] args) {
        ...
        frm.getContentPane().add(btn17);
        frm.getContentPane().add(btn18);
        //43rd line
        frm.getContentPane().add(btn19);
        frm.getContentPane().add(btn20);
        ...
        //4rd line
        frm.getContentPane().add(btn29);
        frm.getContentPane().add(btn30);
